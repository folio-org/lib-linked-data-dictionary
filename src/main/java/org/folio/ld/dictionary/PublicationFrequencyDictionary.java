...
public final class PublicationFrequencyDictionary {
  private static final ImmutableBiMap<String, String> VALUE_MAP =
  ...
  public static Optional<String> getLink(String code) {
    return ofNullable(VALUE_MAP.get(code));
  }

  public static Optional<String> getCode(String link) {
