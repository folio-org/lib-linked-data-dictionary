...
public enum ResourceTypeDictionary implements ResourceType {
  ...
  ID_FAST("http://library.link/identifier/FAST"),
  ID_GND("http://library.link/identifier/GND"),
  ...
  ID_LCCSH("http://library.link/identifier/LCCSH"),
  ID_LCDGT("http://library.link/identifier/LCDGT"),
  ID_LCGFT("http://library.link/identifier/LCGFT"),
  ID_LCMPT("http://library.link/identifier/LCMPT"),
  ID_LCNAF("http://library.link/identifier/LCNAF"),
  ID_LCSH("http://library.link/identifier/LCSH"),
  ID_LOCAL("http://library.link/identifier/LOCAL"),
  ID_MESH("http://library.link/identifier/MESH"),
  ID_STRN("http://library.link/identifier/STRN"),
  ID_UNKNOWN("http://library.link/identifier/UNKNOWN"),
  ID_VIAF("http://library.link/identifier/VIAF"),
  ID_WIKIID("http://library.link/identifier/WikiID"),
  ...
  LIGHT_RESOURCE("http://bibfra.me/vocab/lite/LightResource"),
